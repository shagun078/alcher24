            ...
            <div className="prb">
              ...
              <div className="names_prb">
                <div>
                  <h6>Anurag</h6>
                  <a>
                    Public Relation <br className="line_break" /> Head
                  </a>
                  <br />
                ...
                <div>
                  ...
                  <br />
                  <a href="mailto:ankit.k@alcheringa.in">
                    ankit.k@alcheringa.in
                  </a>
                </div>
                <div>
                  <h6>Lakshya Kohli</h6>
                  ...
                  <br />
                  <a href="mailto:lakshya@alcheringa.in">
                    lakshya@alcheringa.in
                  </a>
                </div>
              </div>
            </div>
            <div className="crm">
              ...
              <div className="names_crm">
                ...
                <div>
                  ...
                  <br />
                  <a href="mailto:harshit@alcheringa.in">
                    harshit@alcheringa.in
                  </a>
                </div>
                <div>
            ...
            <div className="events">
              ...
              <div className="names_events">
                <div>
                  ...
                  <br />
                  <a href="mailto:abhinav@alcheringa.in">
                    abhinav@alcheringa.in
                  </a>
                </div>
                <div>
                  <h6>
            ...
            <div className="mun">
              ...
              <div className="names_mun">
                <div>
                  ...
                  <br />
                  <a href="mailto:iitgmun@alcheringa.in">
