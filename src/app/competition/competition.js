      ...
      <div className="body">
        ...
        <div className="item_box" >
          <div className="item_container">
            {array.map((arr) => {
              return (
                <a href={arr.url} target='_blank' className="icon" id={arr.category}>
                  <Image src={arr.img}
                    alt="Photo"
                    className='iconsIMG'
                    width={1000}
                    ...
                    quality={100}
                  />
                  <p className="margin_top_text"><span>{arr.type}</span>&nbsp;<span className="pad_text_arr">{arr.one_liner}</span></p>
